...
public final class employee_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\tf.action=\"employee?req=v&id=\"+this.id;\n");
      out.write("                        f.submit();\n");
      out.write("\t\t}\n");
      ...
      out.write("                        let s = document.getElementById('genderu');\n");
      out.write("                        if(s.selectedIndex<1) {\n");
      out.write("                            s.selectedIdnex=\"2\";\n");
      out.write("//                            s.selectedIdnex=\"0\";\n");
      out.write("                        }\n");
      out.write("                        console.log( s.selectedIndex);\n");
      ...
      out.write("\t\t};\n");
      out.write("//                function updateem(){\n");
      out.write("//                    document.employeedetails.submit();\n");
      out.write("//                }\n");
      out.write("                function deleteem(id){\n");
      out.write("                    if(confirm(\"Bạn muốn tiếp tục xoá bản ghi này? Thao tác này có thế gây mất dữ liệu!\")){\n");
      out.write("                    let f = document.femployee;\n");
      out.write("                    let req = document.getElementById('req');\n");
      out.write("                    req.value='r';\n");
      out.write("                    f.action=\"employee?req=r&id=\"+id;\n");
      out.write("                    f.submit();\n");
      out.write("                }\n");
      out.write("                };\n");
